...
def get_whois_raw(domain, server="", previous=None, rfc3490=True,
                  never_cut=False, with_server_list=False, server_list=None):
    ...
    if target_server == "whois.jprs.jp":
        request_domain = "%s/e" % domain  # Suppress Japanese output
          ...
          and (target_server == "whois.denic.de"
               or target_server == "de.whois-servers.net")):
